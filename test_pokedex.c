...
static void test_add_pokemon(void) {
    ...
    printf("    ... Adding Bulbaaur to the Pokedex\n");
    add_pokemon(pokedex, charmander);
    
    printf("    ... Checking whether currently selected pokemon is correct");
...
static void test_get_found_pokemon(void) {
    ...
    printf("    ... Creating Charmander and Arceus\n");
    Pokemon charmander = create_charmander();
    ...
    printf("    ... Adding Charmander and Arceus to the Pokedex\n");
    add_pokemon(pokedex,charmander);
...
static Pokemon create_charmander(void){
    Pokemon pokemon = new_pokemon(
            CHARMANDER_ID, CHARMANDER_NAME, CHARMANDER_HEIGHT, CHARMANDER_WEIGHT, CHARMANDER_FIRST_TYPE, CHARMANDER_SECOND_TYPE);
    return pokemon;
}

static Pokemon create_arceus(void){
    Pokemon pokemon = new_pokemon(ARCEUS_ID, ARCEUS_NAME,ARCEUS_HEIGHT,ARCEUS_WEIGHT,ARCEUS_FIRST_TYPE,ARCEUS_SECOND_TYPE);
    return pokemon;
}
